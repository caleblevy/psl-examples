...
readonly DATA_URL='https://linqs-data.soe.ucsc.edu/public/psl-examples-data/mnist-sequence.zip'
readonly DATA_FILE='mnist-sequence.zip'
readonly DATA_DIR='mnist-sequence'
